-- Surface the three categories a person has completed most across their full
-- QuestLife history. Party-originated completions already create normal
-- quest_completions, so repeated Party quests are intentionally included.
