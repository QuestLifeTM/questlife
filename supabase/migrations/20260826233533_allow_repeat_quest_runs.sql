-- Keep completed quests replayable. Earlier function definitions rejected a
-- quest as soon as it had one completion, despite the app's repeat flow.
...
begin
  ...
  -- A run that has already begun may still finish after a quest is unpublished.
  select * into quest
