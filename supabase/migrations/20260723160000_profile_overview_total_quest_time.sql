-- Include all completed solo and Party sessions in the profile's lifetime
-- quest-time stat. The UI formats this value with the same duration helper as
-- the active Quest timer on the Lobby.
