...
export default function AgeOnboardingScreen() {
  ...
  return (
    <View style={styles.root}>
      <View style={[styles.content, { paddingTop: Math.max(insets.top + 24, 36), paddingLeft: insets.left + horizontalPadding, paddingRight: insets.right + horizontalPadding }]}>
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  questionHeader: { paddingBottom: 18, gap: 4 },
  title: { color: T.dark, fontFamily: "RubikBlack", fontSize: 23, lineHeight: 28, letterSpacing: -0.35 },
  helper: { color: T.muted, fontFamily: "RubikBold", fontSize: 13, lineHeight: 18 },
  optionList: { gap: 10 },
  option: { minHeight: 58, paddingHorizontal: 16, borderRadius: 20, borderWidth: 2, borderColor: T.border, backgroundColor: T.white, boxShadow: `4px 4px 0px ${T.border}`, alignItems: "center", justifyContent: "center" },
  optionSelected: { borderColor: T.blue, boxShadow: "4px 4px 0px #258fd8" },
  optionPressed: { transform: [{ translateY: 2 }] },
  optionLabel: { color: T.dark, fontFamily: "Rubik", fontWeight: "600", fontSize: 15.5, lineHeight: 20 },
  optionLabelSelected: { color: T.blue },
  footer: { backgroundColor: T.bg, paddingTop: 10 },
  continueButton: { minHeight: 58, paddingHorizontal: 18, borderRadius: 20, backgroundColor: T.blue, borderBottomWidth: 6, borderBottomColor: "#258fd8", alignItems: "center", justifyContent: "center" },
