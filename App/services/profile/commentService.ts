...
export type QuestPostComment = { id: string; parentId: string | null; body: string; createdAt: string; userId: string; displayName: string; username: string | null; emoji: string; avatarColor: string };
