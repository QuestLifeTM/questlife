    ...
    <Screen padded={false} contentStyle={{ alignItems: "center" }}>
      <View style={{ width: contentWidth, paddingHorizontal: horizontalPadding, gap: 16, transform: [{ translateX: safeAreaOffset }] }}>
        ...
        {tab === "friends" ? <View style={{ gap: 14 }}>
          <View style={{ height: 48, borderRadius: 24, borderWidth: 2, borderColor: T.border, backgroundColor: T.white, flexDirection: "row", alignItems: "center", paddingHorizontal: 14, gap: 8 }}><Ionicons name="search" size={16} color={T.muted} /><TextInput value={query} onChangeText={runSearch} placeholder="Search friends by username..." placeholderTextColor={T.muted} style={{ flex: 1, color: T.dark, fontFamily: "Rubik", fontSize: 15, lineHeight: 20, paddingVertical: 0, includeFontPadding: false, textAlignVertical: "center" }} /></View>
